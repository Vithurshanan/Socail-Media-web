  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-6">
      <div className="h-20 relative">
        ...
        />
        <Image
          src='https://images.pexels.com/photos/27702824/pexels-photo-27702824/free-photo-of-brunette-woman-with-eyes-closed.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load'
          alt=""
          width={48}
          height={48}
